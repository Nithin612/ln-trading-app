...
const STATUS_MAP: Record<Status, {
  ...
  active:    { label: "Active",    icon: Circle,       className: "text-(--color-info)    bg-(--color-info-bg)    border-(--color-info)/20" },
  pending:   { label: "Pending",   icon: Clock,        className: "text-(--color-warning) bg-(--color-warning-bg) border-(--color-warning)/20" },
