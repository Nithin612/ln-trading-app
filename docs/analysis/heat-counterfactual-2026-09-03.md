# Portfolio-heat counterfactual — 2026-09-03
...
|---|--:|--:|--:|--:|--:|
| ADMITTED (capped at 6.0%) | 11 | 10 | ₹-13,641 | ₹-1,364 | 30% |
| SKIPPED (cap would have declined) | 41 | 15 | ₹-5,790 | ₹-386 | 40% |

- Peak open heat the capped book carried: **₹5,997** of the ₹6,000 cap
- Peak concurrent positions: **3** (capped) vs **28** (actual book)

**Read:** [heat counterfactual @ 6.0% of ₹100,000] admitted 11 / skipped 41 · capped ₹-13,641 vs full ₹-19,431 (+5,790) · per-trade ₹-1,364 vs ₹-777 — cap cuts total loss but per-trade is WORSE (₹-1,364 vs ₹-777) — fewer trades at an unchanged expectancy, i.e. a RISK control, not a profitability fix
...
| 2026-09-02 | BOSCH-HCIL | LONG | ₹1,915 | ₹4,144 | 🚫 skipped | open |
