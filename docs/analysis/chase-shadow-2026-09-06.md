# Anti-chase shadow (live signals) — 2026-09-06
...
- **eligible set (the book a flip would leave you holding) — deflated Sharpe bar:** ⏳ does NOT clear · **n=55, and MORE DATA CANNOT RESCUE IT (not ahead of the bar)**
  - observed Sharpe +0.075 does not exceed the 20-trial benchmark +0.256 — more data cannot rescue it; the candidate is not ahead
...
- **eligible set — block bootstrap (2,000 resamples, blocks of 4):** ⏳ the sign does NOT survive resampling
  - observed Sharpe **+0.075** · 90% interval [**-0.093**, +0.237] · median +0.075
  - the Sharpe comes out ≤ 0 in **23%** of plausible histories
