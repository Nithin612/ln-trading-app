# Regime-gate shadow (live cohort) — 2026-09-03
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|
| baseline (all live signals) | 472 | 245 | 33% | +0.011 | 15.9 | +4.9 | +0.020 | 30% |
| gated (kept — would trade) | 271 | 152 | 30% | -0.018 | 33.5 | -5.1 | -0.033 | 28% |
