# Entry-quality shadow (live signals) — 2026-09-12

_Read-only. The entry-quality overlay over the tradeable signal cohort since 2026-07-19 (35 signals). **diversity** is ACTIVE (the ≥2-factor hard rule — single-factor signals do not enter while it is active); **sl_atr** is SHADOW (a tunable stop-tightness floor). A flagged set net-negative and worse than passed is the evidence to flip sl_atr active._

| set | signals | resolved | net ₹ | avg ₹ | win% |
|---|--:|--:|--:|--:|--:|
| diversity FLAGGED (blocked live) | 7 | 0 | — | — | — |
| diversity passed | 28 | 0 | — | — | — |
| sl_atr FLAGGED (shadow) | 14 | 0 | — | — | — |
| sl_atr passed | 21 | 0 | — | — | — |
