# Liquidity shadow (live signals) — 2026-09-06
...
- **eligible set (the book a flip would leave you holding) — deflated Sharpe bar:** ⏳ does NOT clear · **n=76, and MORE DATA CANNOT RESCUE IT (not ahead of the bar)**
  - observed Sharpe -0.102 does not exceed the 20-trial benchmark +0.218 — more data cannot rescue it; the candidate is not ahead
...
- **eligible set — block bootstrap (2,000 resamples, blocks of 5):** ⏳ the sign does NOT survive resampling
  - observed Sharpe **-0.102** · 90% interval [**-0.296**, +0.061] · median -0.124
  - the Sharpe comes out ≤ 0 in **86%** of plausible histories
