# Anti-chase shadow (live signals) — 2026-08-21

_Read-only. The anti-chase overlay recomputed over the tradeable signal cohort since 2026-07-19 (417 signals), each judged on how far past its entry the order actually filled (chase_r = R past entry; the gate's own stamp when present, else the broker's post-fill telemetry). Gate mode: **shadow**. 'chased' = chase_r above the 0.33R ceiling — the reward:risk you were shown is materially gone. A would-block set net-negative AND worse than the near-entry set is the evidence to flip the gate active._

| set | signals | resolved | net ₹ | avg ₹ | win% |
|---|--:|--:|--:|--:|--:|
| CHASED (> 0.33R past entry, would-block) | 3 | 2 | ₹-6,148 | ₹-3,074 | 0% |
| near entry (eligible) | 42 | 33 | ₹7,963 | ₹241 | 61% |
| no data (no chase stamp) | 372 | 36 | ₹-8,564 | ₹-238 | 47% |

**anti-chase flip readiness:** ⏳ NOT READY — 2/20 resolved chased trades (> 0.33R past entry) — keep accruing. Flipping the gate active is behaviour-changing → needs forward evidence + explicit user sign-off (reversible via `chase_gate_mode=shadow`).
...
| 2026-08-14 | LEMERITE | SHORT | +0.317R | ✅ near entry | open/none |
| 2026-08-14 | KSL | SHORT | +0.097R | ✅ near entry | ₹-2,278 |
| 2026-08-14 | CGCL | LONG | +0.079R | ✅ near entry | open/none |
...
| 2026-08-12 | PFIZER | LONG | -0.006R | ✅ near entry | open/none |
...
| 2026-08-05 | ASPINWALL | LONG | +0.779R | 🚫 chased | open/none |
...
| 2026-07-31 | JBMA | SHORT | -0.063R | ✅ near entry | ₹1,506 |
| 2026-07-31 | DMCC | LONG | +0.077R | ✅ near entry | ₹1,205 |
| 2026-07-31 | NATCOPHARM | LONG | +0.833R | 🚫 chased | ₹-2,583 |
| 2026-07-31 | DMCC | LONG | +0.095R | ✅ near entry | open/none |
| 2026-07-23 | SANATHAN | LONG | +0.032R | ✅ near entry | ₹-1,557 |
