# Entry-quality shadow (live signals) — 2026-08-21

_Read-only. The entry-quality overlay over the tradeable signal cohort since 2026-07-19 (417 signals). **diversity** is ACTIVE (the ≥2-factor hard rule — single-factor signals no longer enter); **sl_atr** is SHADOW (measured only). A flagged set net-negative and worse than passed is the evidence to flip sl_atr active._

| set | signals | resolved | net ₹ | avg ₹ | win% |
|---|--:|--:|--:|--:|--:|
| diversity FLAGGED (blocked live) | 48 | 9 | ₹-6,093 | ₹-677 | 44% |
| diversity passed | 369 | 62 | ₹-655 | ₹-11 | 53% |
| sl_atr FLAGGED (shadow) | 83 | 10 | ₹-13,316 | ₹-1,332 | 40% |
| sl_atr passed | 334 | 61 | ₹6,568 | ₹108 | 54% |
