# Sector/index relative-strength shadow (live signals) — 2026-09-04
...
- **eligible set (the book a flip would leave you holding) — deflated Sharpe bar:** ⏳ does NOT clear — observed Sharpe -0.041 does not exceed the 20-trial benchmark +0.241 — more data cannot rescue it; the candidate is not ahead
