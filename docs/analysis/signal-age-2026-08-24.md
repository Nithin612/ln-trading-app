...
| 20–40% | 16 | ₹3,712 | ₹232 | 62% |
| 40–60% | 9 | ₹-4,058 | ₹-451 | 44% |
| 60–80% | 10 | ₹-4,390 | ₹-439 | 40% |
| 80–100% (stale) | 12 | ₹-2,610 | ₹-217 | 42% |
| > 100% (after expiry) | 0 | — | — | — |

**Headline: STALE ENTRIES ARE WORSE.** Fresh (≤40% elapsed): 48 trades, avg ₹87, win 60%. Stale (>80%): 12 trades, avg ₹-217, win 42%.
