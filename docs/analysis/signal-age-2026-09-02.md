...
|---|--:|--:|--:|--:|
| 0–20% (fresh) | 44 | ₹-6,729 | ₹-153 | 55% |
| 20–40% | 21 | ₹-3,511 | ₹-167 | 52% |
| 40–60% | 10 | ₹-2,779 | ₹-278 | 50% |
| 60–80% | 11 | ₹-1,540 | ₹-140 | 45% |
| 80–100% (stale) | 13 | ₹165 | ₹13 | 46% |
| > 100% (after expiry) | 0 | — | — | — |

**Headline: no stale-entry penalty visible yet.** Fresh (≤40% elapsed): 65 trades, avg ₹-158, win 54%. Stale (>80%): 13 trades, avg ₹13, win 46%.
