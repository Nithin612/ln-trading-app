...
|---|--:|--:|--:|--:|--:|--:|--:|--:|
| baseline (all live signals) | 218 | 106 | 37% | +0.015 | 8.8 | +2.8 | +0.027 | 28% |
| gated (kept — would trade) | 117 | 62 | 37% | +0.050 | 4.7 | +5.5 | +0.089 | 30% |
| killed (suppressed) | 101 | 44 | 36% | -0.033 | 8.4 | -2.7 | -0.061 | 26% |
