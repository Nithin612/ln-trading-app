...
|---|--:|--:|--:|--:|--:|--:|
| would-BLOCK | 172 | 19 | ₹326 | ₹515 | ₹779 | 58% |
| eligible (kept) | 380 | 73 | ₹-333 | ₹-106 | ₹138 | 47% |
...
- **eligible set (the book a flip would leave you holding) — deflated Sharpe bar:** ⏳ does NOT clear — observed Sharpe -0.151 does not exceed the 20-trial benchmark +0.222 — more data cannot rescue it; the candidate is not ahead
  - n=73 · mean -332.6033 · sd 2206.0014 · **Sharpe -0.151** · skew -0.18 · kurtosis 3.52
  - P(true Sharpe > 0) = 9.9% · **after deflating for 20 trials: 0.1%** (bar 95%)
