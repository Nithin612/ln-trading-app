# Anti-chase shadow (live signals) — 2026-09-02

_Read-only. The anti-chase overlay recomputed over the tradeable signal cohort since 2026-07-19 (546 signals), each judged on how far past its entry the order actually filled (chase_r = R past entry; the gate's own stamp when present, else the broker's post-fill telemetry). Gate mode: **shadow**. 'chased' = chase_r above the 0.33R ceiling — the reward:risk you were shown is materially gone. A would-block set net-negative AND worse than the near-entry set is the evidence to flip the gate active._

| set | signals | resolved | net ₹ | avg ₹ | win% |
|---|--:|--:|--:|--:|--:|
| CHASED (> 0.33R past entry, would-block) | 4 | 4 | ₹-12,755 | ₹-3,189 | 0% |
| near entry (eligible) | 76 | 51 | ₹3,578 | ₹70 | 55% |
| no data (no chase stamp) | 466 | 36 | ₹-8,564 | ₹-238 | 47% |
...
_… 30 more assessable signals not shown._
