# Regime-gate shadow (live cohort) — 2026-09-12
...
|---|--:|--:|--:|--:|--:|--:|--:|--:|
| baseline (all live signals) | 0 | 0 | — | — | — | +0.0 | — | — |
| gated (kept — would trade) | 0 | 0 | — | — | — | +0.0 | — | — |
| killed (suppressed) | 0 | 0 | — | — | — | +0.0 | — | — |

**Flip readiness:** ⏳ NOT READY — 0/20 resolved suppressed trades — keep accruing. Review checkpoint 2026-09-15 (the real trigger is the count, not the date); flipping also requires explicit user §8 sign-off.

**Verdict:** No live decided trades fall in the skip-set yet — insufficient forward evidence; keep measuring.
