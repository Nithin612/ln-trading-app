# Entry-quality shadow (live signals) — 2026-09-15

_Read-only. The entry-quality overlay over the tradeable signal cohort since 2026-07-19 (38 signals). **diversity** is ACTIVE (the ≥2-factor hard rule — single-factor signals do not enter while it is active); **sl_atr** is SHADOW (a tunable stop-tightness floor). A flagged set net-negative and worse than passed is the evidence to flip sl_atr active._

| set | signals | resolved | net ₹ | avg ₹ | win% |
|---|--:|--:|--:|--:|--:|
| diversity FLAGGED (blocked live) | 7 | 0 | — | — | — |
| diversity passed | 31 | 0 | — | — | — |
| sl_atr FLAGGED (shadow) | 15 | 0 | — | — | — |
| sl_atr passed | 23 | 0 | — | — | — |
